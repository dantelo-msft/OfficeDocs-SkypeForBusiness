...
|**4**   |You can filter what you see on the chart by clicking an item in the legend. For example, click **Unused**, **Domestic used**, **International used**, or **No data** to see only the info related to each one. |
...
|**6**   |Select **Export to Excel** to export table as CSV.|
